...
% load data
load([sourceDir '/' 'IEM_Slopes_Within_Fixed_noArtCorr.mat']);

% load BF results
load([sourceDirBayesResults '/' 'BF_Results_IEM_WIthin_Alpha_RvP_Fixed_noArtCorr.mat']) % need to make this
...
% save figure
% saveas(h,[destDir '/' 'CTF_Slope_Alpha_Within_Fixed_Plus_BFs_Error_Bars_noArtCorr.jpeg'],'jpeg')
% saveas(h,[destDir '/' 'CTF_Slope_Alpha_Within_Fixed_Plus_BFs_Error_Bars_noArtCorr.eps'],'epsc')