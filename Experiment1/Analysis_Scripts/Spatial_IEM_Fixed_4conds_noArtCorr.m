function Spatial_IEM_Fixed_4conds_noArtCorr(sjNum,iSpatialOrColor)
...
if processForIEM==1
    ...
    if iSpatialOrColor==1
        fName = [root, '/IEM_Results_TT_Within_Fixed_noArtCorr/',sprintf('sj%02d_fixed_IEM.mat',sjNum)];
    else
        fName = [root, '/IEM_Results_TT_Within_Fixed_noArtCorr_Color/',sprintf('sj%02d_fixed_IEM.mat',sjNum)];
    end
