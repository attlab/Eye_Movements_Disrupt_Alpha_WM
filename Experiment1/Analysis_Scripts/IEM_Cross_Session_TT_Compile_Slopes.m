...
% set dirs
sourceDir = '/home/waldrop/Desktop/WTF_EYE/IEM_Results_TT_Cross_Session_Gen';
...
for iSub=1:length(subjects)
    sjNum = subjects(iSub);
    load([sourceDir '/' sprintf('sj%02d_IEM_Alpha_Cross_Session_TT.mat',sjNum)])
    all_rSl(iSub,:,:,:) = em.rSl.total;
    all_pSl(iSub,:,:,:) = em.pSl.total;
end

% save compiled data
save([destDir '/' 'Cross_Session_TT_Slope_MASTER.mat'],'all_rSl','all_pSl','-v7.3')
