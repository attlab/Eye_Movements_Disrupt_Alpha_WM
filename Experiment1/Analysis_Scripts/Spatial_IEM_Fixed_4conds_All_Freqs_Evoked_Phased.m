function Spatial_IEM_Fixed_4conds_All_Freqs_Evoked_Phased(sjNum)
...
if processForIEM==1
    ...
    fName = [root, '/IEM_Results_TT_Within_Fixed_All_Freqs_Evoked_Phased/',sprintf('sj%02d_fixed_IEM.mat',sjNum)];
