function Spatial_IEM_Fixed_4conds_Gen_Perm_Evoked_Theta(sjNum)
...
for iCross=1:4
    ...
    for trSamps=1:40
        for teSamps=1:40
            ...
            % store slopes
            em.pSl.evoked(iCross,trSamps,teSamps)=fit(1);
...
if processForIEM==1
    ...
    fName = [root, '/IEM_Results_TT_Within_Fixed_Gen_Perm_Evoked/',sprintf('sj%02d_fixed_IEM.mat',sjNum)];
