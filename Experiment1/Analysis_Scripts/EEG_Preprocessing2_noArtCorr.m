...
function EEG_Preprocessing2_noArtCorr(subjects)
...
if whichPreprocessing==0 % average baseline (use for main spectral\\IEM analyses)
    destDir = [rDir '/' 'EEG_Prepro2_Avg_Baseline_noArtCorr'];
...
for iSub=1:length(subjects)
    ...
    for iSession=theseSessions
        ...
        % save data
        save([destDir '/' sprintf('sj%02d_se%02d_wtfEye.mat',sjNum,iSession)],'eeg','allBehStruct','demographicInfo','pcTrialsRej','-v7.3')
