...
% set dirs
sourceDir = '/home/waldrop/Desktop/WTF_EYE/IEM_Results_TT_Within_Fixed_noArtCorr'; 
...
for iCond=1:4
    ...
    saveas(h,[plotDir '/' 'IEM_Surf_Fixed_noArtCorr' mc '_' ec '.eps'],'epsc')
    saveas(h,[plotDir '/' 'IEM_Surf_Fixed_noArtCorr' mc '_' ec '.jpg'],'jpeg')
end
