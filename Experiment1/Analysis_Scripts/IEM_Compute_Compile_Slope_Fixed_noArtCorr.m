...
sourceDirReal = [rDir '/' 'IEM_Results_TT_Within_Fixed_noArtCorr' ];
sourceDirPerm = [rDir '/' 'IEM_Results_TT_Within_Fixed_Perm_noArtCorr' ];
...
save([destDirCompiled '/' 'IEM_Slopes_Within_Fixed_noArtCorr.mat'],...
    'rSl_total',...
    'pSl_total',...
    'rSl_total_LF',...
    'pSl_total_LF','-v7.3')
