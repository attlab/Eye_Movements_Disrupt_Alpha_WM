function IEM_Fixed_4conds_Gen_Perm(sjNum)
                ...
                for teLoop = 1:40
                    ...
                    for i=1:nBlocks % loop through blocks, holding each out as the test set
                        ...
                        if i == 1 || i == 2
                            ...
                            tf_total_cond1(iter,perm,trLoop,teLoop,cond1Total_i,:) = mean(C2_cond1,1);
                        ...
                        elseif i == 3 || i == 4
                            ...
                            tf_total_cond2(iter,perm,trLoop,teLoop,cond2Total_i,:) = mean(C2_cond2,1);
                        ...
                        elseif i == 5 || i == 6
                            ...
                            tf_total_cond3(iter,perm,trLoop,teLoop,cond3Total_i,:) = mean(C2_cond3,1);
                        ...
                        elseif i == 7 || i == 8
                            ...
                            tf_total_cond4(iter,perm,trLoop,teLoop,cond4Total_i,:) = mean(C2_cond4,1);
...
tf_total_cond1 = squeeze(mean(mean(mean(tf_total_cond1,1),2),5));
tf_total_cond2 =  squeeze(mean(mean(mean(tf_total_cond2,1),2),5));
tf_total_cond3 = squeeze(mean(mean(mean(tf_total_cond3,1),2),5));
tf_total_cond4 =  squeeze(mean(mean(mean(tf_total_cond4,1),2),5));
...
for iCross=1:4
    ...
    for trSamps=1:40
        for teSamps=1:40
            ...
            % store slopes
            em.pSl.total(iCross,trSamps,teSamps)=fit(1);
...
if processForIEM==1
    ...
    fName = [root, '/IEM_Results_TT_Within_Fixed_Gen_Perm/',sprintf('sj%02d_fixed_IEM.mat',sjNum)];
