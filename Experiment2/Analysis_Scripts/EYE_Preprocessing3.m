...
sourceDir = '/home/waldrop/Desktop/SCAMS/Eye_Synchronized';
destDir = '/home/waldrop/Desktop/SCAMS/Eye_Synchronized2';

% select subject number (just one)
%subjects=[1:17,19,21:24,27,28];
...
for iSub = 1:length(subjects)
    ...
    for iCond=1:4
        for iSession=1:2
            ...
            for iTrial=1:size(eyeData.allTimes,1)
                ...
                tIdx = (idx-125):(idx+988); % final 11 samples lost?
    ...
    save([destDir '/' sprintf('sj%02d_eye_beh_sync_pro.mat',sjNum)],'eyeProcessed','-v7.3')
