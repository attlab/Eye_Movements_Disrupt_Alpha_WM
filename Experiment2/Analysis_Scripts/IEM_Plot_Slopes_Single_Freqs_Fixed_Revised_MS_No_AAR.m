...
sourceDirBayesResults = '/home/waldrop/Desktop/SCAMS/R_Results';

% load data
load([sourceDir '/' 'IEM_Slopes_Within_Fixed_No_AAR.mat']);

% load BF results
load([sourceDirBayesResults '/' 'BF_Results_IEM_WIthin_Alpha_RvP_Fixed_No_AAR.mat'])
...
h=figure('Units','Normalized','OuterPosition',[0.0052    0.2165    0.4859    0.7549]); % change these numbers to change plot size
subplot(2,1,1);
for iCond=1:4
...
% save figure
saveas(h,[destDir '/' 'CTF_Slope_Alpha_Within_Fixed_Plus_BFs_Error_Bars_No_AAR.jpeg'],'jpeg')
saveas(h,[destDir '/' 'CTF_Slope_Alpha_Within_Fixed_Plus_BFs_Error_Bars_No_AAR.eps'],'epsc')