...
% add paths
rmpath(genpath('/home/waldrop/Desktop/SCAMS/Dependencies/eeglab14_1_2b')) % removes the EEGLAB version we've been using for everything else
cd('/home/waldrop/Desktop/SCAMS/Analysis_Scripts');
cd('/home/waldrop/Desktop/SCAMS/Dependencies/eeglab2019_1');
eeglab
%clear
close all
cd('/home/waldrop/Desktop/SCAMS/Analysis_Scripts');
...
rmpath(genpath('/home/waldrop/Desktop/SCAMS/Dependencies/eeglab2019_1')) % removes the EEGLAB version we've been using for everything else
