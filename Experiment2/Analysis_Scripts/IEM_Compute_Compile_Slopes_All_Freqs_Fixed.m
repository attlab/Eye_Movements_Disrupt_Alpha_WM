...
sourceDirReal = [rDir '/' 'IEM_Results_TT_Within_Fixed_All_Freqs' ];
sourceDirPerm = [rDir '/' 'IEM_Results_TT_Within_Fixed_All_Freqs_Perm' ];
...
save([destDirCompiled '/' 'IEM_Slopes_All_Freqs_Fixed.mat'],...
    'rSl_total',...
    'pSl_total',...
    'rSl_total_LF',...
    'pSl_total_LF','-v7.3')
