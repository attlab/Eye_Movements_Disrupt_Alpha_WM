...
sourceDirReal = [rDir '/' 'IEM_Results_TT_Within_Fixed_All_Freqs_Evoked_Frontal_Chans_Only' ];
sourceDirPerm = [rDir '/' 'IEM_Results_TT_Within_Fixed_All_Freqs_Evoked_Perm_Frontal_Chans_Only' ];
...
save([destDirCompiled '/' 'IEM_Slopes_All_Freqs_Fixed_Evoked_Frontal_Chans_Only.mat'],...
    'rSl_evoked',...
    'pSl_evoked',...
    'rSl_evoked_LF',...
    'pSl_evoked_LF','-v7.3')
