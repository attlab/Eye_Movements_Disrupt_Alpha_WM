function IEM_Fixed_All_Freqs_Frontal_Chans_Only(sjNum)
...
if processForIEM==1
    ...
    fName = [root, '/IEM_Results_TT_Within_Fixed_All_Freqs_Frontal_Chans_Only/',sprintf('sj%02d_fixed_IEM.mat',sjNum)];
