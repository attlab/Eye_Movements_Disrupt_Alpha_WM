...
% load data
load([sourceDir '/' 'IEM_Slopes_Within_Fixed_COLOR.mat']);

% load BF results
load([sourceDirBayesResults '/' 'BF_Results_IEM_WIthin_Alpha_RvP_Fixed_COLOR.mat'])
...
h=figure('Units','Normalized','OuterPosition',[0    0.0417    1.1113    0.7083]); % change these numbers to change plot size
for iCond=1:4
...
% save figure
saveas(h,[destDir '/' 'CTF_Slope_Alpha_Within_Fixed_COLOR.jpeg'],'jpeg')
saveas(h,[destDir '/' 'CTF_Slope_Alpha_Within_Fixed_COLOR.eps'],'epsc')