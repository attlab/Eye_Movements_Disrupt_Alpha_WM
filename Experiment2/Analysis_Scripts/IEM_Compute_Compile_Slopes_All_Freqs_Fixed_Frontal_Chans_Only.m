%{
IEM_Fixed_All_Freqs_Compute_Compile_Slopes
...
Last updated 02.02.22 by Tom Bullock for SCAMS
...
sourceDirReal = [rDir '/' 'IEM_Results_TT_Within_Fixed_All_Freqs_Frontal_Chans_Only' ];
sourceDirPerm = [rDir '/' 'IEM_Results_TT_Within_Fixed_All_Freqs_Frontal_Chans_Only_Perm' ];
...
for iSub=1:length(subjects)
    ...
    for iCond=1:4
        ...
        if      iCond==1; theseDataReal = allReal.em.tfs_cond1.total; theseDataPerm = allPerm.em.tfs_cond1.total;
        elseif  iCond==2; theseDataReal = allReal.em.tfs_cond2.total; theseDataPerm = allPerm.em.tfs_cond2.total;
        elseif  iCond==3; theseDataReal = allReal.em.tfs_cond3.total; theseDataPerm = allPerm.em.tfs_cond3.total;
        elseif  iCond==4; theseDataReal = allReal.em.tfs_cond4.total; theseDataPerm = allPerm.em.tfs_cond4.total;
        end
...
save([destDirCompiled '/' 'IEM_Slopes_All_Freqs_Fixed_Frontal_Chans_Only.mat'],...
    'rSl_total',...
    'pSl_total',...
    'rSl_total_LF',...
    'pSl_total_LF','-v7.3')
...
% % do some quick and dirty plots
% for iPlot=1:4
%     
%     subplot(1,4,iPlot)
%     imagesc(squeeze(mean(rSl_total(:,iPlot,:,:),1)));
%     pbaspect([1,2,1])
% end