...
eye movement cue (center>newLoc>center).  Just plot for the newLoc position.  Calculate an average euclidian distance error over
...
% set dirs
sourceDir = '/home/waldrop/Desktop/SCAMS/Eye_Synchronized2';
destDir = '/home/waldrop/Desktop/SCAMS/EYE_Euclidian_Error_Mats';
...
for iSub=1:length(subjects)
    ...
    for iCond=3:4
        ...
        for iTrial=1:nTrials
            ...
            centerX=1920/2;%1024/2; % orig
            centerY=1080/2;%768/2; % orig
            ...
            % get eye movements for each movement window [tom edited one
            % window only
            theseTimes = [500,1500]; % was [500,1000]
...
%                 e4(j) = sqrt((fixLoc2(1)-ex2(j))^2 + (fixLoc2(2)-ey2(j))^2);
            ...
            %TOM MODIFIED FOR SCAMS (1 EM ONLY)
